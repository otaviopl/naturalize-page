      ...
      <Container maxWidth="lg">
        <Grid container spacing={{ xs: 4, md: 6 }} justifyContent="center" sx={{ mt: 0, mb: 0 }}>
          ...
          <Grid item xs={12} md={4} sx={{ mb: { xs: 4, md: 0 } }}>
            ...
            <Typography variant="body2" sx={{ opacity: 0.9, mb: 2, maxWidth: 350, fontSize: { xs: '0.8rem', md: '1rem' }, textAlign: { xs: 'center', md: 'left' } }}>
              Transformando sorrisos com excelência, tecnologia e cuidado personalizado. Nossa missão é proporcionar tratamentos odontológicos de alta qualidade em um ambiente acolhedor e confortável.
            </Typography>
            <Stack direction="row" spacing={2} sx={{ mt: 2, mb: { xs: 2, md: 0 }, justifyContent: { xs: 'center', md: 'flex-start' } }}>
              <IconButton
                component="a"
                href="https://www.instagram.com/naturalizeodontologia/"
                target="_blank"
                rel="noopener noreferrer"
                sx={{ backgroundColor: 'rgba(255,255,255,0.08)', color: 'white', '&:hover': { backgroundColor: 'rgba(255,255,255,0.18)' } }}
              >
                <Instagram size={20} />
              </IconButton>
            </Stack>
          ...
          <Grid item xs={12} md={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: { xs: 'center', md: 'flex-end' }, textAlign: { xs: 'center', md: 'right' }, mb: { xs: 4, md: 0 } }}>
            <Typography variant="h6" className="gold-gradient-text" gutterBottom>
              Links Rápidos
            </Typography>
            <Stack spacing={1} sx={{ width: { xs: '100%', md: 'auto' }, alignItems: { xs: 'center', md: 'flex-end' } }}>
              <Link 
                href="#hero" 
                color="inherit" 
                underline="hover"
              ...
              <Link href="#profissionais" color="inherit" underline="hover">Equipe</Link>
              <Link href="#depoimentos" color="inherit" underline="hover">Depoimentos</Link>
              <Link href="#contato" color="inherit" underline="hover">Contato</Link>
            </Stack>
          </Grid>

          {/* Coluna 3: Serviços */}
          <Grid item xs={12} md={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: { xs: 'center', md: 'flex-end' }, textAlign: { xs: 'center', md: 'right' } }}>
            <Typography variant="h6" className="gold-gradient-text" gutterBottom>
              Serviços
            </Typography>
            <Stack spacing={1} sx={{ width: { xs: '100%', md: 'auto' }, alignItems: { xs: 'center', md: 'flex-end' } }}>
        ...
        >
          ...
          <Stack direction="row" spacing={2} sx={{ flex: 1, justifyContent: { xs: 'center', md: 'flex-end' } }}>
