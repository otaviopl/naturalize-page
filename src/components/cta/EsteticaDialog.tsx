...
export default function EsteticaDialog({ open, onClose }: EsteticaDialogProps) {
  return (
    ...
    >
      <DialogTitle id="estetica-dialog-title" sx={{ 
        fontWeight: 600,
        color: 'primary.main',
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <Typography variant="body1" paragraph id="estetica-dialog-description">
              Nossos tratamentos estéticos são realizados com tecnologia de ponta e materiais de primeira qualidade, 
              garantindo resultados naturais e duradouros para seu sorriso.
            </Typography>
